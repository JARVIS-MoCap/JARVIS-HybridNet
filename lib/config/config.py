...
_C.EXPERIMENT_NAME = "Colleen_d2_Run1"
_C.NUM_GPUS = 1
_C.GPU_IDS = None
...
_C.EFFICIENTTRACK.BATCH_SIZE = 1
_C.EFFICIENTTRACK.OPTIMIZER = 'adamw'
_C.EFFICIENTTRACK.LEARNING_RATE = 0.0001
...
_C.VORTEX.GRID_DIM_X = [-450,450]
_C.VORTEX.GRID_DIM_Y = [-300,300]
_C.VORTEX.GRID_DIM_Z = [100,1100]
_C.VORTEX.ROI_CUBE_SIZE = 208

_C.VORTEX.BATCH_SIZE = 1
_C.VORTEX.OPTIMIZER = 'adamw'
_C.VORTEX.LEARNING_RATE = 0.001
_C.VORTEX.CHECKPOINT_SAVE_INTERVAL = 10
