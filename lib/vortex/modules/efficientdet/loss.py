...
loss.py
=======
Implementation of FocalLoss Module used for EfficientDet.
"""
...
class FocalLoss(nn.Module):
    ...
    :type classifications: torch.tensor
    :param regression: TODO
    :type regression: torch.tensor
    :param anchors: TODO
    :type anchors: torch.tensor
    :param annotations: TODO
    :type annotations: torch.tensor
    :return: Stacked classification and regression losses
